...
from run_qmsum import build_vanilla_prompt, get_context, build_worker_prompt, build_manager_prompt
...
def main():
    ...
    for model_id in MODELS:
        print(f"\nEvaluating Model: {model_id} on QMSum ({args.mode} mode)")
        ...
        try:
            ...
            print("\n--- 3. RAG Pipeline ---")
            run_rag(model, tokenizer, dataset, "QMSum", build_vanilla_prompt, compute_rouge, model_id)
